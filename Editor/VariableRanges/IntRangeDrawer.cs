...
{
    /// <summary>
    /// A custom property drawer for <see cref="IntRange"/>.
    /// </summary>
    ...
    public class IntRangeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var lower = EditorGUI.IntField(rects[0], lowerProperty.intValue);
            EditorGUI.LabelField(rects[1], "-");
            var upper = EditorGUI.IntField(rects[2], upperProperty.intValue);
            if (lower > upper)
                upper = lower;
